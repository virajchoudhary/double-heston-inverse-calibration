...
- The quadrature tests cover controlled fixtures, not every extreme allowed parameter combination.
- Synthetic recovery does not establish unique identification or performance on real NIFTY surfaces.
- Provisional parameter ranges require empirical and external review before full ANN research training.
