...
def components(c):
    f = {'protocol manifest': OUT / 'manifest.json', 'protocol manifest sha256': OUT / 'manifest.sha256', 'scenario bank': OUT / 'scenario_bank.json',
         ...
         'reporting addendum manifest': OUT / 'reporting_addendum_manifest.json', 'PINN candidate selection': OUT / 'pinn_selection.json',
         'analysis plan predeclaration': OUT / 'analysis_plan_predeclaration.json'}
