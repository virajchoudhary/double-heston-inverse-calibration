"""Deribit XRP_USDC option surfaces from the public historical trade archive.
...
def fetch(date, hours, url, prefix, cache):
    """Every XRP option trade in [date hours[0]:00, hours[1]:00) UTC, cached gzip; returns trades and file sha256."""
